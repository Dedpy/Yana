...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <h1 class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"><a href="main.php">YANA</h1>
      ...
      <a href="views/login.php" class="appointment-btn scrollto">Connexion</a>
    </div>
  </header><!-- End Header -->
...
<div class="container d-md-flex py-4">
  ...
  <div class="mr-md-auto text-center text-md-left">
    ...
    <div>
      <a href="../back-end/views/connexion.php">Espace Administration</a>
    </div>
    <div class="credits">
