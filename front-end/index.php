...
<section></section>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Bienvenue à yana </h1>
      <h2>Sante et le bien etre - groupe 3 de classe 2A28</h2>
      <a href="#about" class="btn-get-started scrollto">Introduction</a>
    </div>
  </section><!-- End Hero -->
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Pourquoi YANA?</h3>
              <p>
                vous propose des services facilitant le suivi de votre santé. Adaptés à votre mode de vie, ces derniers vous permettent de mieux communiquer avec vos médecins et de bénéficier d'une meilleure prise en charge dans votre parcours de soin. Vous prenez rendez-vous en ligne pour une consultation en téléconsultation.
              </p>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container">
        <div class="row mt-5">
          ...
          <form name="f" action="crud.php" method="POST" enctype="multipart/form-data "onSubmit="return verif()">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
							<div>
                  <input class="form-control" type="text"  name="msgreclamation" id="msgreclamation" placeholder="Reclamation">
								<div class="clearfix"></div>
							</div>
							<button type="submit" name="subbb">POST</button>
            </form>
