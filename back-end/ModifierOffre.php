                        ...
                        <div class="row">
                            <div class="col-12">
                             ...
                             <form  method="POST">
                                ...
                                <td>ID_Offre</td>
                                <td><input type="text" name="offre" value="<?PHP echo $row['idOffre']; ?>"></td>
                                </tr>
                                ...
                                <tr>
                                <td>ID_Produit</td>
                                <td><input type="text" name="produit_id" value="<?PHP echo $row['produit_id']; ?>"></td>
                                </tr>

                                 <tr>
                                <td>Pourcentage de la remise</td>
                                <td><input type="text" name="pourcentage" value="<?PHP echo $row['pourcentage']; ?>"></td>
                                </tr>
                                ...
                                <button type="submit"  name="modifier" class="btn btn-primary btn-bordred waves-effect w-md waves-light m-b-5">Modifier Offre</button> 
                                ...
                                {   
                                        ...
                                        $p->modifierOffre($offre,$_GET['id']);
                                       // echo "<meta http-equiv=\"refresh\" content=\"0;URL=ModifierOffre.php?id=".$_GET['idOffre']."\">";
                                ...
                                <a href="ListeDesOffres.php"> <input type="submit" name="retour" class="btn btn-success" value="Retour">
