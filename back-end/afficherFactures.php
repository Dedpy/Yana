                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table  table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <th data-priority="1">Total en DT</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?PHP echo number_format($row['total'],3); ?></td>
                                                    <td><?PHP echo $row['statut']; ?></td>
                                                    <td>
                                                        <form method="POST" action="afficherFacture.php">
                                                            <button type="submit" class="btn btn-info waves-effect w-md waves-light m-b-5">Détails</button>
                                                            <input type="hidden" value="<?PHP echo $row['ref']; ?>" name="ref">
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <form method="POST" action="ModifierFacture.php">
                                                            <button type="button" class="btn btn-primary waves-effect w-md waves-light m-b-5">Modifier</button>
                                                            <input type="hidden" value="<?PHP echo $row['ref']; ?>" name="ref">
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <form method="POST" action="envoyerFacture.php">
                                                            <button class="btn btn-inverse waves-effect waves-light m-b-5">
                                                    ...
                                                    <td>
                                                        <form method="POST" action="supprimerFacture.php">
                                                            <button type="button" class="btn btn-danger waves-effect w-md waves-light m-b-5" <?PHP if ($row['type']!="manual"){ echo 'disabled="true"';}?>>Supprimer</button>
                                                            <input type="hidden" value="<?PHP echo $row['ref']; ?>" name="ref">
                                                        </form>
                                                    </td>
                                                </tr>
