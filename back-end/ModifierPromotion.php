                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav list-inline navbar-left">
                            ...
                            <li class="list-inline-item">
                                <br>
                                <h4 class="page-title">Modifier Une Promotion </h4>
                            </li>
                        </ul>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="AjouterPromotion.html">Ajouter Promotion</a></li>
                                    <li><a href="ListeDesPromotions.php">Liste Des Promotions</a></li>
                                    <li><a href="AjouterOffre.html">Ajouter Offre</a></li>
                     ...
                     <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-google-pages"></i><span> Newsletter</span> <span class="menu-arrow"></span></a>
                                ...
                                <div class="card-box table-responsive">
                                   ...
                                   <script type="text/javascript">
                                      ...
                                      function check()
                                      {
                                         ...
                                         var validite=window.document.formulaire.validite.value;

                                         if(validite>1) 
                                         {
                                            alert("Erreur, la valeur de la validité  doit être  0 ou 1");
                                         }
                                          ...
                                          var pourcentage=window.document.formulaire.pourcentage.value;
                                          if(pourcentage>50)
                                          {
                                            alert("Erreur, le pourcentage doit être compris entre 5% et 50% ");
                                          }
                                  ...
                                  <?php
                                    ...
                                    $p=new PromotionManage();
                                    $list=$p->recupererPromotion($_GET['id']);
                             ...
                             <form  name=formulaire method="POST">
                                ...
                                <tr>
                                   <?php
                                    foreach ($list as $row) 
                                    {?>
                                <td>Code de promotion</td>
                                <td><input type="text" name="code" value="<?PHP echo $row['codePromo']; ?>"></td>
                                </tr>
                                ...
                                <button onclick="check()" type="submit"  name="modifier" class="btn btn-primary btn-bordred waves-effect w-md waves-light m-b-5" >Modifier Promotion</button> 
                                ...
                                {   
                                        ...
                                        $p->modifierPromotion($promotion,$_GET['id']);
                                        echo "<meta http-equiv=\"refresh\" content=\"0;URL=ModifierPromotion.php?id=".$_GET['id']."\">";
                                ...
                                <a href="ListeDesPromotions.php"> <input type="submit" name="retour" class="btn btn-success" value="Retour">
