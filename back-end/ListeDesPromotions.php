                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav list-inline navbar-left">
                            ...
                            <li class="list-inline-item">
                                <h4 class="page-title">Liste des promotions</h4>
                            </li>
                        </ul>
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    {?>
                                        <tr>
                                            ...
                                            <td>
                                             <a href="ModifierPromotion.php?id=<?php echo $val['codePromo'] ; ?>">
                                            ...
                                            <button  class="btn btn-icon waves-effect waves-light btn-warning m-b-5">  <i class="fa fa-wrench"></i>  </button>
                                                ...
                                                <input type="hidden" value="<?PHP echo $val['codePromo']; ?>" name="code">
                                                     </form>
                                                 </td>
